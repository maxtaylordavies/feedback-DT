...
base_call = f"python {PROJECT_HOME}/scripts/train_agent_babyai_cluster_test.py --num_repeats 128 -o {DATA_HOME}/output"
...
output_file = open(
    f"{PROJECT_HOME}/scripts/experiments/{EXPERIMENT_NAME}/experiment.txt", "w+"
)
