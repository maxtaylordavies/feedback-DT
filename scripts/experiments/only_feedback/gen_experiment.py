...
EXPERIMENT_NAME = "random_feedback"
...
base_call = f"python {PROJECT_HOME}/scripts/train_agent_babyai.py -o {DATA_HOME}/output --load_existing_dataset True --use_mission False --use_feedback True --feedback_mode random"
# --eps_per_shard 4
